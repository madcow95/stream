    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <!-- <form role="form" action="/board/register" method="post"> -->
          ...
          <div class="form-group">
            <label>Subject</label> <input class="form-control" name='subject' value="${boardList.subject }" disabled="disabled">
          </div>
          ...
          <form action="${ctx}/board/modify" method="get" id="operForm">
          	...
          	<input type="hidden" id="scopeId" name="scopeId" value="${sessionScope.memList.id}">
          </form>
        <!-- </form> -->
      </div>
      <!--  end panel-body -->
